...
local fluidMessage = {"Aaaach...", "Blech!", "Mmmm...", "Aaaah...", "Aaaah...", "Uff!", "Uch!", "Aah...", "Uuuuf!"}
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if target:isCreature() then
		if item.type == 0 then
			player:sendTextMessage(MESSAGE_STATUS_SMALL, "To naczynie jest puste.")
		elseif target == player then
			...
			player:say("Gulgul.", TALKTYPE_MONSTER_SAY)
		else
