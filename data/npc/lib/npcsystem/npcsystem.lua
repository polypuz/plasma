...
if NpcSystem == nil then
	...
	FOCUS_GREETWORDS = {'hi', 'elo', 'hejka', 'siema', 'czesc', 'witam', 'uszanowanie', 'uszanowanko', 'no elo', 'hello'}
	FOCUS_FAREWELLWORDS = {'no to ide', 'nara', 'bye', 'farewell', 'dozo', 'do widzenia', 'do zobaczenia', 'eldo'}

	-- The word for requesting trade window. For more information look at the top of modules.lua
	SHOP_TRADEREQUEST = {'trade', 'wymiana', 'wymien'}
