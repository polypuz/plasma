...
if NpcHandler == nil then
	...
	NpcHandler = {
		...
		messages = {
			...
			[MESSAGE_BUY] = "Czy na pewno chcesz kupic |ITEMCOUNT| |ITEMNAME| za |TOTALCOST| sztuk zlota?",
			[MESSAGE_ONBUY] = "Prosze bardzo.",
			[MESSAGE_BOUGHT] = "Kupiles |ITEMCOUNT|x |ITEMNAME| za |TOTALCOST| sztuk zlota.",
			[MESSAGE_SELL] = "Czy chcesz sprzedac |ITEMCOUNT| |ITEMNAME| za |TOTALCOST| sztuk zlota?",
			[MESSAGE_ONSELL] = "Prosze, oto Twoje |TOTALCOST| zlotych monet.",
			[MESSAGE_SOLD] = "Sprzedales |ITEMCOUNT|x |ITEMNAME| za |TOTALCOST| sztuk zlota.",
			[MESSAGE_MISSINGMONEY] = "Obawiam sie, ze nie masz wystarczajaco duzo pieniedzy.",
			[MESSAGE_NEEDMONEY] = "Obawiam sie, ze nie masz wystarczajaco duzo pieniedzy.",
			[MESSAGE_MISSINGITEM] = "Nie masz az tylu przedmiotow.",
			[MESSAGE_NEEDITEM] = "Nie posiadasz tego przedmiotu.",
			[MESSAGE_NEEDSPACE] = "Nie dasz rady tyle uniesc.",
			[MESSAGE_NEEDMORESPACE] = "Nie dasz rady uniesc az tylu rzeczy.",
			[MESSAGE_IDLETIMEOUT] = "Do widzenia!",
			[MESSAGE_WALKAWAY] = "...czesc?",
			[MESSAGE_DECLINE] = "No to nie.",
			[MESSAGE_SENDTRADE] = "Pewnie. Oto co moge Ci zaoferowac.",
			[MESSAGE_NOSHOP] = "Wybacz, ale nie mam nic na sprzedaz.",
			[MESSAGE_ONCLOSESHOP] = "Wpadnij kiedys jeszcze!",
			[MESSAGE_ALREADYFOCUSED] = "|PLAYERNAME| halo? Mowie do Ciebie.",
			[MESSAGE_WALKAWAY_MALE] = "Zycze Panu milego dnia.",
			[MESSAGE_WALKAWAY_FEMALE] = "Aby Slonce swiecilo urokliwej Pani!"
		}
	}
