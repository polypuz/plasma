...
function  creatureSayCallback(cid, type, msg)
  ...
  if msg == "odwilz" and talkState[talkUser] == 1 then
  ...
  if msg == "dziadek" and talkState[talkUser] == 1 then   
  ...
  if msg == "medal" and player:getStorageValue(23021) == 1 and player:getItemCount(ItemType(10140):getId()) < 1 then
    selfSay('Musisz szukac we wraku na zachod od miasta.', cid)
      talkState[talkUser] = 0
    end
     
    if msg == "medal" and player:getStorageValue(23021) == 1 and player:getItemCount(ItemType(10140):getId()) > 0 then -- 10140 - Royal Medal (ze skrzynki)
