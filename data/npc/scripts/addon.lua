local config = {
	[1] = {female = 136, male = 128, nazwa = 'Citizen', male_jeden = {{5876, 100}}, male_dwa = {{2480, 1}, {5902, 50}, {5890, 100}},
	female_jeden = {{5876, 100}}, female_dwa = {{2480, 1}, {5902, 50}, {5890, 100}}},
	...
	[10] = {female = 149, male = 145, nazwa = 'Wizard', male_jeden = {{2536, 1}, {2492, 1}, {2488, 1}, {2123, 1}}, male_dwa = {{5922, 50}},
	female_jeden = {{2536, 1}, {2492, 1}, {2488, 1}, {2123, 1}}, female_dwa = {{5922, 50}}},
...
local function creatureSayCallback(cid, type, msg)
	...
	if isInArray({"outfit", "addon", "addons", "dodatki", "dodatek"}, msg) then
